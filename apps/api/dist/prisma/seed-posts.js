...
const samplePosts = [
    { title: 'iPhone 13 Pro Max 256GB', description: 'Në gjendje të shkëlqyer, vetëm 6 muaj përdorim. Bateria 98%. Me kutinë origjinale dhe aksesorë.', price: 85000, categoryId: 'c1000000-0000-0000-0000-000000000001' },
    ...
    { title: 'MacBook Pro 14" M2', description: 'MacBook Pro 2023, 16GB RAM, 512GB SSD. Përdorur vetëm për punë, pa asnjë gërvishtje.', price: 180000, categoryId: 'c1000000-0000-0000-0000-000000000002' },
    ...
    { title: 'AirPods Pro 2', description: 'Të reja, të papërdorura, me faturë. USB-C version.', price: 25000, categoryId: 'c1000000-0000-0000-0000-000000000004' },
    { title: 'PlayStation 5', description: 'PS5 Disk Edition me 2 kontrollerë dhe 3 lojëra. Përdorur 1 vit.', price: 45000, categoryId: 'c0000000-0000-0000-0000-000000000006' },
    { title: 'Samsung 55" 4K Smart TV', description: 'Televizor Samsung QLED, 55 inch, 4K, HDR. Si i ri.', price: 60000, categoryId: 'c1000000-0000-0000-0000-000000000004' },
    { title: 'Canon EOS R6 Camera', description: 'Aparat fotografik profesional, me objektiv 24-70mm. Shutter count 5000.', price: 220000, categoryId: 'c1000000-0000-0000-0000-000000000003' },
    ...
    { title: 'Mercedes C200 2020', description: 'Mercedes-Benz C200, viti 2020, 45,000 km, ngjyrë e bardhë. Servisi i plotë.', price: 3200000, categoryId: 'c2000000-0000-0000-0000-000000000001' },
    ...
    { title: 'Honda CBR 600RR 2019', description: 'Motoçikletë sportive, 15,000 km, asnjë aksidentë, gjendje perfekte.', price: 650000, categoryId: 'c2000000-0000-0000-0000-000000000002' },
    ...
    { title: 'Apartament 1+1 Blloku', description: 'Apartament modern 1+1 në Blloku, 55m2, mobiluar, kati 4. 350€/muaj.', price: 350, categoryId: 'c3000000-0000-0000-0000-000000000002' },
    ...
    { title: 'Kollltuk L-Shape', description: 'Kollltuk modern L-shape, ngjyrë gri, pëlhurë, 3.5m gjatësi.', price: 45000, categoryId: 'c4000000-0000-0000-0000-000000000001' },
