...
// Sample posts with category slugs (matching seed.sql structure)
const samplePosts = [
    // Electronics - Celularë
    ...
    // Properties - Apartamente me Qira
    ...
    // Properties - Apartamente në Shitje
    ...
    // Fashion - Modë (using main category)
...
async function main() {
    ...
    // Repeat sample posts to reach 100
